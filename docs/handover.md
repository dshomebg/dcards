...
**Деплойнати и SHP-1/2a/2b (release 9607d2f). Готови локално: SHP-2c (имейл за поръчка) и
SHP-3 (админ на поръчките, миграция `0006`). Етап 3 е завършен.** Следва етап 4: картово плащане,
статистика на сканиранията, Pro gating, имейли при регистрация/смяна на парола.
...
2. Етап 4: analyzer за статистика на сканиранията (`/app/cards` графики, `scans` по ден/устройство),
   Pro gating (`can()` вече е там), после картово плащане (Stripe? — решение на собственика).
